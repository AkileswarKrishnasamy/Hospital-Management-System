...
public interface AppointmentRepository extends JpaRepository<Appointment, Integer> {
	...
	public int deleteByDoctorId(Integer doctorId);
	@Modifying
	@Transactional
	@Query(value="delete from appointment WHERE patient_id = ?1;", nativeQuery=true)
	...
	@Query(value="SELECT * FROM db.appointment WHERE doctor_id=?1 ",nativeQuery=true)
